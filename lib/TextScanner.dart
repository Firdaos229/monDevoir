...
class _TextScannerState extends State<TextScanner> with WidgetsBindingObserver {
  ...
  void initState() {
    super.initState();
    //ajoutons WidgetsBinding pour afficher le flux de la camera.
  ...
  //verifier si l'application est en arrière plan ou non
  @override
        ...
        builder: (context, snapshot) {
          return Stack(
            children: [
              ...
              Scaffold(
                appBar: AppBar(
                  title: const Text('Texte reconnu'),
                ),
                backgroundColor:
  ...
  Future<void> scanImage() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Erreur lors de la numérisation du texte !'),
        ),
      );
    }
  }
